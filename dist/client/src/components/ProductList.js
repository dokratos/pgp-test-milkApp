...
const ProductList = () => {
    ...
    return (<main>
       <div className="relative">
        ...
        <input type='text' placeholder='Search' value={text} onChange={e => setText(e.target.value)} className='block w-80 p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-50'></input>
